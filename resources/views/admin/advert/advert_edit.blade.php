                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            ...
                            <a href="{{ route('advert.index') }}" class="btn btn-primary">All Adverts</a>
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                ...
                                <form action="{{ route('advert.update', $advert->id) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="title" name="title" value="{{ $advert->title }}" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="description">Description:</label>
                                        <textarea class="form-control" id="description" name="description" required>{{ $advert->description }}</textarea>
                                    </div>
                                    <div class="form-group">
                                        ...
                                        <hr>
                                        @if($advert->image)
                                            <img src="{{ asset('storage/' . $advert->image) }}" alt="{{ $advert->title }}" width="100">
                                        @endif
                                    </div>
