                                ...
                                <table id="zero-config" class="table table-bordered table-hover dataTable table-condensed mb-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $invest->max_invest }}</td>
                                            <td>{{ $invest->average_month }}</td>
                                            <td>{{ $invest->created_at->format('d M Y') }}</td>
                                            <td class="text-center">
                                                <ul class="table-controls">
                                                    <li>
                                                        <a href="{{ route('investment.edit', $invest->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('investment.destroy', $invest->id) }}" method="POST" style="display:inline-block;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" style="border:none; background:none;" class="warning confirm btn btn-danger delete-button" data-id="{{ $invest->id }}" data-toggle="tooltip" data-placement="top" title="Delete">
