                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <a href="{{ route('team.create') }}" class="btn btn-primary">Add New Team Member</a>
                            ...
                            <div class="table-responsive mb-4 mt-4">
                                <table id="zero-config" class="table table-bordered table-hover dataTable table-condensed mb-4">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            <td>{{ $team->id }}</td>
                                            <td><img src="{{ asset('images/team/' . $team->image) }}" alt="{{ $team->name }}" width="100"></td>
                                            <td>{{ $team->name }}</td>
                                            <td>{{ $team->position }}</td>
                                            ...
                                            <td class="text-center">
                                                <ul class="table-controls">
                                                    <li>
                                                        <a href="{{ route('team.edit', $team->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('team.destroy', $team->id) }}" method="POST" style="display:inline-block;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" style="border:none; background:none;" class="warning confirm btn btn-danger delete-button" data-id="{{ $team->id }}" data-toggle="tooltip" data-placement="top" title="Delete">
