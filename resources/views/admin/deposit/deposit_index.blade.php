                ...
                <div class="row layout-top-spacing" id="cancel-row">
                    <div class="col-xl-12 col-lg-12 col-sm-12  layout-spacing">
                        <div class="widget-content widget-content-area br-6">
                            <a href="{{ route('admin_deposits.create') }}" class="btn btn-primary">Add New Deposit</a>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <ul class="table-controls">
                                                    <li>
                                                        <a href="{{ route('admin_deposits.edit', $deposit->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('admin_deposits.destroy', $deposit->id) }}" method="POST" style="display:inline-block;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" style="border:none; background:none;" class="warning confirm btn btn-danger delete-button" data-id="{{ $deposit->id }}" data-toggle="tooltip" data-placement="top" title="Delete">
