                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <ul class="table-controls">
                                                    <li>
                                                        <a href="{{ route('review.edit', $review->id) }}" data-toggle="tooltip" data-placement="top" title="Edit">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('review.destroy', $review->id) }}" method="POST" style="display:inline-block;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" style="border:none; background:none;" class="warning confirm btn btn-danger delete-button" data-id="{{ $review->id }}" data-toggle="tooltip" data-placement="top" title="Delete">
