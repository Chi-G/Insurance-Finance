                                                ...
                                                <ul class="table-controls">
                                                    ...
                                                    <li>
                                                        <form action="{{ route('faq.destroy', $faq->id) }}" method="POST" style="display:inline-block;">
                                                            @csrf
                                                            @method('DELETE')
                                                            <button type="button" style="border:none; background:none;" class="warning confirm btn btn-danger delete-button" data-id="{{ $faq->id }}" data-toggle="tooltip" data-placement="top" title="Delete">
